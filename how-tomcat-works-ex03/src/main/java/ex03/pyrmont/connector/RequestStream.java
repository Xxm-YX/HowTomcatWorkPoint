...
/**
 * Convenience implementation of <b>ServletInputStream</b> that works with the standard implementations
 * of <b>Request</b>.
 * If the content length has been set on our associated Request, this implementation will enforce
 * not reading more than that many than that many bytes on the underlying stream.
 */
public class RequestStream extends ServletInputStream {
     ...
     * 这个方法的意思 就是关闭这个流，如果流里面还有数据，先读完再关闭
     * @throws IOException
     */
    @Override
    ...
    /**
     * Read and return a single byte from this input stream,or -1 end of
     ...
     * as an integer. This method blocks until input data is
     ...
     * possibly zero. The method of bytes actually read is returned as an integer.
     * This method blocks until input data is available,
     * end of file is detected, or an exception is thrown.
     *
     * @param b The bufferr into which the data is read
